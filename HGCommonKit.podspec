#
# Be sure to run `pod lib lint HGCommonKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HGCommonKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HGCommonKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/harleyGit/HGCommonKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'harleyGit' => 'harleysor@qq.com' }
